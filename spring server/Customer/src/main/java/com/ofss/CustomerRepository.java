...
public class CustomerRepository {
	...
	public void addCustomer(Customer updatedCustomer) {
		...
		jdbcTemplate.update(sql, updatedCustomer.getFirstName(), updatedCustomer.getLastName(),
				updatedCustomer.getMobileNumber(), updatedCustomer.getEmail(), updatedCustomer.getPanNumber(),
	...
	public void updateCustomer(Long customerId, Customer updatedCustomer) {
		...
		jdbcTemplate.update(sql, updatedCustomer.getFirstName(), updatedCustomer.getLastName(),
				updatedCustomer.getMobileNumber(), updatedCustomer.getEmail(), updatedCustomer.getPanNumber(),
				updatedCustomer.getPassword(), customerId);
	}
	...
	public Customer getCustomerById(Long customerId) {
		...
		return jdbcTemplate.queryForObject(sql, new Object[] { customerId }, (rs, rowNum) -> {
			...
			c.setPanNumber(rs.getString("pannumber")); // Column name should be all lowercase if your schema is
														// case-insensitive
	...
	public Customer getCustomerByEmail(String email) {
		...
		return jdbcTemplate.queryForObject(sql, new Object[] { email }, (rs, rowNum) -> {
			...
			c.setPanNumber(rs.getString("pannumber")); // Column name should be all lowercase if your schema is
														// case-insensitive
			c.setPassword(rs.getString("password")); // Not set, as password isn't in the
			// customer table (recommended)
			return c;
		});
	}
